    ...
    <div className="min-h-screen p-3 sm:p-4 md:p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mt-6 flex justify-center">
          <button
            onClick={handleShare}
            className="bg-green-600 text-white px-6 sm:px-8 py-2 sm:py-3 rounded-lg font-semibold hover:bg-green-700 active:bg-green-800 transition-colors text-sm sm:text-base flex items-center justify-center gap-2"
          >
